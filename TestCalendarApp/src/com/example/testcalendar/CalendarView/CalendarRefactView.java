package com.example.testcalendar.CalendarView;

import java.text.SimpleDateFormat;
import java.util.ArrayList;
import java.util.Calendar;

import com.example.testcalendarapp.R;
 ...
 */  
public class CalendarRefactView extends LinearLayout {   
     ...
     */  
    public CalendarRefactView(Context context) {   
        this(context, null);   
    }   
     ...
     */  
    public CalendarRefactView(Context context, AttributeSet attrs) {   
        super(context, attrs);   
